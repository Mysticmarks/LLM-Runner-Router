...
echo ""
echo "Access points:"
echo "  🌐 Health:       http://178.156.181.117:3000/health"
echo "  📊 Diagnostics:  http://178.156.181.117:3000/api/diagnostics"
echo "  🔧 Manual heal:  http://178.156.181.117:3000/api/heal"
echo ""